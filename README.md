...
Using React, make a simple application for managing a “to-do” list (ex: buy milk, do laundry, take out the trash, etc.)
...
Live Website: https://javascript-react-task-list.herokuapp.com/
